...
This project includes a motor controlled from stm32. Motor is connected to 3.3v power source through a transistor, base of which is connected to the stm32. stm32 uses PWM to give signal to transistor's base, controling motor's rotation speed.
